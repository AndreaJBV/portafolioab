...
const Nav = () => {
    return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overfow-hidden z-50'>
        <div className='container mx-auto'>
            { /*van inner */}
            <div className='w-full bg-pink h-[96px] backdrop-blur-2xl rounded-full max-w-[460px] mx-auto px-5 flex justify-between items-center text-2xl text-white'>
